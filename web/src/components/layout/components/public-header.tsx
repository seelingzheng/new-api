...
export function PublicHeader(props: PublicHeaderProps) {
  ...
  if (preferCustomNavLinks && navLinks.length > 0) {
    links = navLinks
  }
      ...
      >
        ...
        >
          ...
          >
            ...
            {/* Desktop nav */}
            <div className='public-header-nav hidden items-center gap-0.5 sm:flex'>
              {showNavigation &&
                links.map((link) => {
            ...
            {rightContent && (
              <div className='public-header-right hidden items-center gap-2 sm:flex'>
                {rightContent}
              </div>
            )}
